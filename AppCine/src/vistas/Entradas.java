...
public class Entradas {
	...
	public Entradas() {
		...
		spinner2.setModel(new SpinnerNumberModel(0, 0, 8, 1));
		spinner3 = new JSpinner();
		
		spinner3.setModel(new SpinnerNumberModel(0, 0, 8, 1));
		spinner4 = new JSpinner();
	
		spinner4.setModel(new SpinnerNumberModel(0, 0, 8, 1));
		spinner5 = new JSpinner();
	
		spinner5.setModel(new SpinnerNumberModel(0, 0, 8, 1));
	...
	public void eventos() {
		...
		spinner.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent arg0) {
				...
				int entradas=(int)spinner.getValue()+(int)spinner2.getValue()+(int)spinner3.getValue()+(int)spinner4.getValue()+(int)spinner5.getValue();
				int precio=entradas*8;
				String str=String.valueOf(precio);
				lblpreciototal2.setText(str);
